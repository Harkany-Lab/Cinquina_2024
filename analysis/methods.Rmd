...
write_bib(c("base", "Seurat", "SeuratWrappers", "SeuratData", "sctransform",
            ...
            "RColorBrewer", "Azimuth", "BPCells", "DESeq2", "ggplot2", 
...
versions <- list(
    ...
    BPCells = packageVersion("BPCells"),
...
eicosapentaenoic acid (EPA) at 5 μM, 10 μM, and 30 μM concentrations was
...
All analyses were performed using R v`r R.version.string`. Key packages
